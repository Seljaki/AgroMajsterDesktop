...
@Composable
fun menu(onLogOutClicked: () -> Unit, onListCompaniesClicked: () -> Unit, onGeneratorClicked: () -> Unit, onScraperClicked: () -> Unit, onPlotListClicked: () -> Unit, onInvoicesClicked: () -> Unit){
    ...
    MenuButton(Icons.Default.Info, "Polja", onClick = onPlotListClicked)
